...
public class GooView extends View{
	...
	private PointF dragCenter = new PointF(200f, 200f);//拖拽圆的圆心
	private PointF stickyCenter = new PointF(200f, 200f);//固定圆的圆心
	
	private PointF[] stickyPoint = {new PointF(200f, 188f),new PointF(200f, 212f)};
	private PointF[] dragPoint = {new PointF(200f, 188f),new PointF(200f, 212f)};
